...
function buildHandoffs(): Handoff[] {
  ...
  const caseTypes = [
    { code: "田宮電機",     actions: ["盡職調查委託", "財報補件追蹤", "估值區間確認"] },
    { code: "西大阪鋼鐵",   actions: ["產業分析委託", "競品比較表審閱", "投資契約準備"] },
    { code: "駒田工業",     actions: ["二次訪談紀錄", "估值試算", "投委會決議轉達"] },
    { code: "東京中央銀行", actions: ["NDA 草案審閱", "客戶背景調查", "簽約時程確認"] },
    { code: "斯派拉爾",     actions: ["技術初評", "創辦人面談紀錄", "市場調研"] },
    { code: "福斯特連鎖酒店集團", actions: ["連鎖品牌審查", "市場大小估算", "客戶留存分析"] },
    { code: "帝國航空",     actions: ["客戶接觸排程", "管理層會議", "投資簡報"] },
    { code: "伊勢島飯店",   actions: ["退場稅務評估", "退場時機分析", "投組季報資料"] },
    { code: "太洋證券",     actions: ["法律意見書追蹤", "監管風險評估", "結案報告"] },
    { code: "電腦雜技集團", actions: ["盡調進度同步", "客戶結構分析", "估值期待對齊"] },
    { code: "牧野精機",     actions: ["技術盡調", "客戶訪談紀錄", "財務模型驗證"] },
    { code: "開發投資銀行", actions: ["A 輪追加評估", "董事會資料審閱", "KPI 達成檢視"] },
    { code: "白水銀行",     actions: ["徵信報告審閱", "授信額度評估", "聯貸條件確認"] },
    { code: "竹下金屬",     actions: ["供應鏈訪查", "原料成本試算", "ESG 風險評估"] },
    { code: "Skyhope",      actions: ["技術架構評估", "團隊背景查核", "估值對齊"] },
    { code: "小村建設",     actions: ["工程進度核對", "履約保證審閱", "資金撥付確認"] },
  ];
...
export const SEED_DECISIONS: Decision[] = [
  // 執行中 (7 筆)
  { id: "d1", title: "田宮電機 Pre-A 輪投資金額上限", content: "決議對田宮電機 Pre-A 輪投資上限為 3,000 萬，估值不得高於 4 億。",
  ...
  { id: "d8", title: "駒田工業二次盡調", content: "決議對駒田工業進行第二輪深度盡調，重點在客戶留存率與商業模式驗證。",
  ...
  { id: "d9", title: "下季業務開發 KPI", content: "決議將下季新客戶接觸數提升至 12 家，加強對 FinTech 領域開發。",
    ...
    status: "執行中" },
  { id: "d10", title: "東京中央銀行 NDA 條款修訂", content: "決議接受東京中央銀行提出的 NDA 修訂建議，由資管部完成最終版本。",
  ...
  { id: "d12", title: "伊勢島飯店退場稅務優化方案", content: "決議完成伊勢島飯店退場稅務試算與優化方案評估。",
  ...
  { id: "d14", title: "太洋證券法律意見書回覆", content: "決議由投研部協助太洋證券取得法律意見書。",
  ...
  { id: "d16", title: "開發投資銀行 A 輪追加投資", content: "決議對既有投資開發投資銀行追加 A 輪投資 1,500 萬。",
  ...
  { id: "d6", title: "伊勢島飯店初步退場時機", content: "決議啟動伊勢島飯店退場評估，目標 6 個月內完成。",
